    ...
    <div className="homeprice">
      ...
      <div className="container">
        <div className="">
          ...
          <p>
            We offer transparent and flexible pricing tailored to fit businesses
            of all sizes. Whether you're just getting started or scaling up, our
            plans are designed to deliver value without compromising quality.
          </p>
        </div>
